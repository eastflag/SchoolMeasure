...
namespace HealthCare
{
	public partial class InbodyControl : UserControl
	{
		...
		private void btnComplete_Click(object sender, EventArgs e)
		{
			...
			bool isSuccess = adoUtil.InsertSmokeMeasureInfo(student, smokeInfo);
		...
		private void dgvSmokeMember_SelectionChanged(object sender, EventArgs e)
		{
			...
			if (selectedIndex >= 0)
			{
				...
				student.ID = member_id.ToString();
				student.Name = dgvSmokeMember.Rows[selectedIndex].Cells[1].Value.ToString();
				student.SchoolID = dgvSmokeMember.Rows[selectedIndex].Cells[8].Value.ToString();
				student.Grade = dgvSmokeMember.Rows[selectedIndex].Cells[2].Value.ToString();
				student.Grade_ID = GetGradeId(student.Grade, dgvSmokeMember.Rows[selectedIndex].Cells[9].Value.ToString());
				student.ClassNumber = dgvSmokeMember.Rows[selectedIndex].Cells[3].Value.ToString();
				student.Measure_Date = DateTime.Now.ToString("yyyy-MM-dd");
				student.LastMeasureDate = last_measure_date;
				student.UpdateMeasureSeq = last_measure_id;
			}
